package com.ptk.disample2.module

import com.ptk.disample2.*
...
object UtilsModule {
    ...
    fun provideInformation() =
        Information(
            provideHobbies(), provideSkills(), provideAccomplishment()
        )
    ...
    fun provideResume() =
        Resume(
            provideEducation(), provideExperience(), provideInformation()
        )
    ...
    fun provideEmployee() =
        Employee(
            provideEducation(), provideExperience(), provideResume(), provideInformation()
        )
